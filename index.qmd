...
.wrapper {
    display: grid;
    grid-gap: 1px;
    grid-template-columns: 205px 205px 205px 400px;
...
::: {.box .d}
```{r gauge_blocks_leon,fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_casos_leon, out.height='100%', out.width = '100%', fig.align = "center"}
